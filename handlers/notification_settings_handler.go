...
func (self *NotificationSettingWithChannelHandler) Post(request *gottp.Request) {
	...
	ntfication := notification.GetFromDatabase(db.DbConnection, inputNotification.User, inputNotification.ApplicationID, inputNotification.OrganizationID, inputNotification.Type)
...
func (self *NotificationSettingWithChannelHandler) Delete(request *gottp.Request) {
	...
	ntfication = notification.GetFromDatabase(db.DbConnection, ntfication.User, ntfication.ApplicationID, ntfication.OrganizationID, ntfication.Type)
